    ...
    return {
      ...
      link: function(scope, elm) {
        ...
        if (scope.exam.location.display) {
          ...
          scope.exam.location.buildingLinkName = scope.exam.location.raw_location;
        }
        ...
        if (scope.exam.location.display) {
          ...
          buildingTooltipName += ' ' + scope.exam.location.raw_location;
        }
        ...
        if (scope.exam.location.lat && scope.exam.location.lon) {
          element = $compile('<a data-ng-href="https://maps.google.com/maps?q={{exam.location.lat}},{{exam.location.lon}}+({{exam.location.buildingLinkName}})" title="{{exam.location.buildingTooltipName}}">{{exam.location.raw_location}} <i class="cc-icon fa fa-map-marker"></i></a>')(scope);
        } else {

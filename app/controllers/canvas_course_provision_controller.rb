class CanvasCourseProvisionController < ApplicationController
  ...
  def job_status
    course_provision_job = Canvas::CanvasProvideCourseSite.find(params[:job_id])
    render json: course_provision_job.to_json and return if course_provision_job.class == Canvas::CanvasProvideCourseSite

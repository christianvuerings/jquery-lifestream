class MyUpNext < UserSpecificModel
  ...
  def get_feed_internal
    ...
    return up_next if (is_acting_as_nonfake_user?) && !Google::GoogleProxy.allow_pseudo_user?
    return up_next if !Google::GoogleProxy.access_granted?(@uid)
  ...
  def fetch_events(uid)
    google_proxy = Google::GoogleEventsListProxy.new(user_id: uid)

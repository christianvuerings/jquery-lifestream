module Oec
  class Courses < OecExport
    ...
    def headers
      'COURSE_ID,COURSE_NAME,CROSS_LISTED_FLAG,CROSS_LISTED_NAME,DEPT_NAME,CATALOG_ID,INSTRUCTION_FORMAT,SECTION_NUM,PRIMARY_SECONDARY_CD'
    end

    def append_records(output)
      Oec::OecData.get_all_courses.each do |course|
        ...
        if course["cross_listed_name"].present?
          ...
          cross_listings = Oec::OecData.get_all_courses(course["cross_listed_name"])

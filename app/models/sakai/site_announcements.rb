  ...
  class SiteAnnouncements < Proxy
    ...
    def get_all_announcements
      ...
      self.class.fetch_from_cache @site_id do
        announcements = []
        @tool_id = Sakai::SakaiData.get_announcement_tool_id(@site_id)
        if (@tool_id)
          ann_rows = Sakai::SakaiData.get_announcements(@site_id, start_time, end_time)

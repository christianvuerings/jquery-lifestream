module MyBadges
  class Merged < UserSpecificModel
    ...
    def init
      @enabled_sources ||= {
        "bcal" => {access_granted: Google::GoogleProxy.access_granted?(@uid),
                     source: MyBadges::GoogleCalendar.new(@uid),
                     pseudo_enabled: Google::GoogleProxy.allow_pseudo_user?},
        "bdrive" => {access_granted: Google::GoogleProxy.access_granted?(@uid),
                     source: MyBadges::GoogleDrive.new(@uid),
                     pseudo_enabled: Google::GoogleProxy.allow_pseudo_user?},
        "bmail" => {access_granted: Google::GoogleProxy.access_granted?(@uid),

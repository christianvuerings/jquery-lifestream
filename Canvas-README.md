...
* `RAILS_ENV=production rake canvas:full_refresh`
...
* `RAILS_ENV=production rake canvas:make_csv_files`
...
* `RAILS_ENV=production rake canvas:repair_sis_ids TERM_ID='TERM:2013-C'`

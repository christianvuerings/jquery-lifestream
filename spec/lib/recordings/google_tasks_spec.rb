...
describe "GoogleTaskList" do
  ...
  it "should simulate a fake task toggle between statuses" do
    ...
    # Create task list
    create_proxy = Google::GoogleCreateTaskListProxy.new proxy_opts
    ...
    # Insert task
    insert_proxy = Google::GoogleInsertTaskProxy.new proxy_opts
    ...
    update_proxy = Google::GoogleUpdateTaskProxy.new proxy_opts
    ...
    clear_completed_tasklist_proxy = Google::GoogleClearTaskListProxy.new proxy_opts
    ...
    get_tasks_proxy = Google::GoogleTasksListProxy.new proxy_opts
    ...
    #Delete task
    delete_proxy = Google::GoogleDeleteTaskProxy.new proxy_opts
    response = delete_proxy.delete_task(test_task_list_id, new_task_id)
    response.should be_true

    # Delete task list
    delete_proxy = Google::GoogleDeleteTaskListProxy.new proxy_opts

...
describe Cache::UserCacheWarmer do
  ...
  it "should warm the cache when told" do
    ...
    model_classes = [ User::UserApi, MyClasses::Merged, Financials::MyFinancials, MyGroups::Merged, MyTasks::Merged, MyActivities::Merged, UpNext::MyUpNext, MyBadges::Merged ]

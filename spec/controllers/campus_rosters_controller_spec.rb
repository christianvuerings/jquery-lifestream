...
describe CampusRostersController do
  ...
  let(:roster_feed) do
    {
      ...
      :students=>[
        ...
        {:student_id=>"23154488", :first_name=>"Dwight", :last_name=>"Schrute", :email=>"dk.schrute@example.com", :enroll_status=>"E", :section_ccns=>["25653"], :id=>"952577", :login_id=>"952577", :profile_url=>"https://calnet.berkeley.edu/directory/details.pl?uid=952577", :sections=>[{:id=>"25653"}], :photo=>"/campus/compsci-9a-2014-D/photo/952577"},
  ...
  context 'when serving course rosters csv download' do
    ...
    it "should return csv file when user is authorized" do
      ...
      expect(response_csv[0]['Name']).to eq 'Michael Scott'
      ...
      expect(response_csv[1]['Name']).to eq 'Dwight Schrute'

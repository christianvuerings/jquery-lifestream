...
describe MyTasksController do
  ...
  before(:each) do
    ...
    @fake_google_clear_tasks_proxy = Google::GoogleClearTaskListProxy.new(fake: true)
    @fake_google_delete_tasks_proxy = Google::GoogleDeleteTaskProxy.new({fake: true})
  end
  ...
  it "should return a valid truthy json object when successfully clearing completed google tasks" do
    ...
    Google::GoogleClearTaskListProxy.stub(:new).and_return(@fake_google_clear_tasks_proxy)
  ...
  it "should successfully delete a google task" do
    session[:user_id] = @user_id
    Google::GoogleProxy.stub(:access_granted?).and_return(true)
    Google::GoogleDeleteTaskProxy.stub(:new).and_return(@fake_google_delete_tasks_proxy)
    ...
    Google::GoogleDeleteTaskProxy.any_instance.stub(:delete_task).and_return(valid_delete_response)

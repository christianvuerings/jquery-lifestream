describe CanvasCsv::Ldap do
  ...
  context 'LDAP connectivity' do
    it 'should search and return people', :testext => true do
      ...
      args = {}
      args[:base] = CanvasCsv::Ldap::PEOPLE_DN
    ...
    it 'should receive array when querying guest updates', :testext => true do
      canvas_ldap = CanvasCsv::Ldap.new
    ...
    it 'should have access to dependent attributes for guest entries', :testext => true do
      client = subject.client
      args = {}
      args[:base] = CanvasCsv::Ldap::GUEST_DN

...
describe Bearfacts::BearfactsTelebearsProxy do
  let!(:fake_oski) { Bearfacts::BearfactsTelebearsProxy.new({:user_id => "61889", :fake => true}).get }
  let!(:live_oski) { Bearfacts::BearfactsTelebearsProxy.new({:user_id => "61889", :fake => false}).get }
  let!(:live_non_student){ Bearfacts::BearfactsTelebearsProxy.new({user_id: '212377'}).get }

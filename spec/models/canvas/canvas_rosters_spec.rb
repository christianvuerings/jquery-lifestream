...
describe Canvas::CanvasRosters do
  it "should return a list of officially enrolled students for a unlinked Canvas course site" do
    ...
    model = Canvas::CanvasRosters.new(teacher_login_id, canvas_course_id: course_id)
    feed = model.get_feed
  ...
  it "should give access to Canvas course instructors" do
    ...
    model = Canvas::CanvasRosters.new(user_id, canvas_course_id: teaching_site_id)
    model.user_authorized?.should be_true
    model = Canvas::CanvasRosters.new(user_id, canvas_course_id: student_site_id)

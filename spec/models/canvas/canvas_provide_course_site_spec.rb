...
describe Canvas::CanvasProvideCourseSite do

  let(:uid)                           { rand(99999).to_s }
  let(:canvas_provide_course_site)    { Canvas::CanvasProvideCourseSite.new(uid) }
  ...
  describe ".unique_job_id" do
    it "returns unique job id based on current time" do
      ...
      result = Canvas::CanvasProvideCourseSite.unique_job_id
  ...
  describe ".find" do
    it "returns the current job object from global storage" do
      ...
      result = Canvas::CanvasProvideCourseSite.find('canvas.courseprovision.1234.123456789')
  ...
  describe "#initialize" do
    it "raises exception if uid is not a String" do
      expect { Canvas::CanvasProvideCourseSite.new(1234) }.to raise_error(ArgumentError, "uid must be a String")
    end
    ...
    it "initializes with unique cache key" do
      Canvas::CanvasProvideCourseSite.stub(:unique_job_id).and_return('1383330151057')
  ...
  describe "#create_course_site" do
    ...
    it "sets status as completed and saves" do
      canvas_provide_course_site.create_course_site("fall-2013", ["1136", "1204"])
      cached_object = Canvas::CanvasProvideCourseSite.find(canvas_provide_course_site.job_id)
  ...
  describe "#expire_instructor_sites_cache" do
    it "clears canvas course site cache for user/instructor" do
      Canvas::CanvasMergedUserSites.should_receive(:expire).with(canvas_provide_course_site.uid).and_return(nil)
  ...
  describe "#course_site_url" do
    it "should raise exception if no response from Canvas::Course" do
      Canvas::Course.any_instance.stub(:course).and_return(nil)
      expect do
    ...
    it "should return course site URL when provided with valid sis id" do
      ...
      Canvas::Course.any_instance.stub(:course).and_return(course_response)
  ...
  describe "#candidate_courses_list" do
    ...
    it "should get properly formatted candidate course list from fake Oracle MV", :if => SakaiData.test_data? do
      ...
      terms_feed = Canvas::CanvasProvideCourseSite.new("238382").candidate_courses_list
  ...
  describe "#generate_unique_sis_course_id" do
    ...
    it "should raise exception if unique course id not generated after 20 attempts" do
      ...
      end.to raise_error(Canvas::CanvasProvideCourseSite::IdNotUniqueException)
    end
  end
  ...
  describe "#generate_section_definitions" do
    ...
    it "should generate Canvas Section import CSV rows for the selected courses" do
      ...
      Canvas::ExistenceCheck.any_instance.stub(:section_defined?).and_return(false)
  ...
  describe "#subaccount_for_department" do
    ...
    it "should raise exception if the subaccount does not exist in Canvas" do
      Canvas::ExistenceCheck.any_instance.stub(:account_defined?).and_return(false)
  ...
  describe "#save" do
    ...
    it "saves current state of job to global storage" do
      ...
      retrieved_job = Canvas::CanvasProvideCourseSite.find(canvas_provide_course_site.job_id)
      retrieved_job.class.should == Canvas::CanvasProvideCourseSite

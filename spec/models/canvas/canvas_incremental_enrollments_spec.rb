...
describe Canvas::CanvasIncrementalEnrollments do
  ...
  describe '.canvas_section_enrollments' do
    it "raises exception if canvas_section_id argument not an integer" do
      expect { Canvas::CanvasIncrementalEnrollments.canvas_section_enrollments('123456') }.to raise_error(ArgumentError, "canvas_section_id must be a Fixnum")
    end

    it "returns section enrollments with students and instructors segregated" do
      result = Canvas::CanvasIncrementalEnrollments.canvas_section_enrollments(123456)
    ...
    it "logs existence of non-sis user enrollments" do
      logger = double
      Canvas::CanvasIncrementalEnrollments.stub(:logger).and_return(logger)
  ...
  describe '#refresh_existing_term_sections' do
    ...
    before do
      ...
      Canvas::CanvasIncrementalEnrollments.stub(:canvas_section_enrollments).and_return({:students => 'student_enrollments_array', :instructors => 'instructor_enrollments_array'})
    end

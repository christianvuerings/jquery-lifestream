describe OecLegacy::Queries do

  let(:test_ccn) do
    OecLegacy::Queries.test_data? ? '7309' : '7203'
  end
  before do
  ...
  context 'looking up students' do
    let(:all_students) { OecLegacy::Queries.get_all_students [test_ccn] }

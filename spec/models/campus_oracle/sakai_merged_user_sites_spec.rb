...
describe Sakai::SakaiMergedUserSites do
  let(:uid) {'300939'}
  subject {Sakai::SakaiMergedUserSites.new(user_id: uid).get_feed}
  ...
  context 'when running against test data', :if => Sakai::SakaiData.test_data? do

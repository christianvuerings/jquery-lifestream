...
describe CampusSolutions::Phone do
  ...
  context 'post' do
    let(:params) { {} }
    let(:fake_proxy) { CampusSolutions::Phone.new(fake: true, user_id: random_id, params: params) }
  ...
  context 'with a real external service', :testext => true do
    ...
    let(:real_proxy) { CampusSolutions::Phone.new(fake: false, user_id: random_id, params: params) }

  ...
  if ENV["UI_TEST"]
    ...
    context 'when adding a task' do
      ...
      it 'allows the user to show more overdue tasks in ascending date order' do
        (1..11).each do |i|
          ...
          wait_for_task.until { @to_do_card.overdue_task_one_date == WebDriverUtils.ui_date_rendered_format(date) }
      ...
      it 'allows the user to show more tasks due today in ascending creation sequence' do
        (1..11).each do |i|
          ...
          wait_for_task.until { @to_do_card.last_today_task_date == WebDriverUtils.ui_date_rendered_format(date) }
      ...
      it 'allows the user to show more tasks due in the future in ascending date order' do
        (1..11).each do |i|
          ...
          wait_for_task.until { @to_do_card.last_future_task_date == WebDriverUtils.ui_date_rendered_format(date) }
      ...
      it 'allows the user to show more unscheduled tasks in descending creation sequence' do
        (1..11).each do |i|
          ...
          wait_for_task.until { @to_do_card.unsched_task_one_date == WebDriverUtils.ui_date_rendered_format(today) }
    ...
    context 'when editing an existing task' do
      ...
      it 'allows a user to make an unscheduled task overdue' do
        ...
        expect(@to_do_card.overdue_task_one_date).to eql(WebDriverUtils.ui_date_rendered_format(yesterday))
      end
      ...
      it 'allows a user to make an unscheduled task due today' do
        ...
        expect(@to_do_card.today_task_one_date).to eql(WebDriverUtils.ui_date_rendered_format(today))
      end
      ...
      it 'allows a user to make an unscheduled task due in the future' do
        ...
        expect(@to_do_card.future_task_one_date).to eql(WebDriverUtils.ui_date_rendered_format(tomorrow))
      end
      ...
      it 'allows a user to make an overdue task unscheduled' do
        ...
        expect(@to_do_card.unsched_task_one_date).to eql(WebDriverUtils.ui_date_rendered_format(today))
      end
      ...
      it 'allows a user to edit multiple scheduled tasks at once' do
        ...
        expect(@to_do_card.overdue_task_one_date).to eql(WebDriverUtils.ui_date_rendered_format(yesterday - 1))
        ...
        expect(@to_do_card.future_task_one_date).to eql(WebDriverUtils.ui_date_rendered_format(tomorrow + 1))

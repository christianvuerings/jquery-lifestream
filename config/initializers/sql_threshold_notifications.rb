if Settings.logger.slow_query_threshold_in_ms.to_i > 0
  Rails.logger.warn "Logging all sql.active_record notifications with threshold > #{Settings.logger.slow_query_threshold_in_ms.to_i}ms"
